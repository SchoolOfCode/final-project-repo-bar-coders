...
function MyApp({ Component, pageProps }) {
      ...
      const [inProgressBooks, setInProgressBooks] = useState([
            ...
            },
            {
                  ...
                  cover: "https://www.artemis-fowl.com/wp-content/uploads/2019/03/2019-artemis-fowl-cover-book-one.jpg",
            },
            {
                  id: 4,
                  title: "Unknown Book",
      ...
      async function updateWordsList(newWord, meaning) {
            try {
                  const url =
                        "https://fourweekproject.herokuapp.com/dictionary";
                  await fetch(url, {
                        method: "POST",
                        headers: {
                              authorization: `Bearer ${fetchToken}`,
